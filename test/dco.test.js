...
const dontRequireSignoffFor = (allowedLogin) => async (login) => {
  ...
  describe("Single commit", () => {
    describe("Success patterns", () => {
      test("Single commit is correctly signed-off", async () => {
        ...
        const dcoObject = await getDCOStatus(
          [{ commit, author: { login: "bkeepers" }, parents: [], sha: shaA }],
          alwaysRequireSignoff,
          prInfo,
          { individual: false, thirdParty: false }
        );
      ...
      test('Single commit is correctly signed-off with case-insensitive "signed-off-by:"', async () => {
        ...
        const dcoObject = await getDCOStatus(
          [{ commit, author: { login: "hiimbex" }, parents: [], sha: shaA }],
          alwaysRequireSignoff,
          prInfo,
          { individual: false, thirdParty: false }
        );
      ...
      test("Single commit is correctly signed-off by committer, author does not exist", async () => {
        ...
        const author = null;
        const dcoObject = await getDCOStatus(
          [{ commit, author, parents: [], sha: shaA }],
          alwaysRequireSignoff,
          prInfo,
          { individual: false, thirdParty: false }
        );
      ...
      test("Single verified commit is from an org member, no sign-off", async () => {
        ...
        const dcoObject = await getDCOStatus(
          [{ commit, author: { login: "lptr" }, parents: [], sha: shaA }],
          dontRequireSignoffFor("lptr"),
          prInfo,
          { individual: false, thirdParty: false }
        );
        ...
        expect(dcoObject).toEqual([
          {
            ...
            message:
              'Can not find "Author Name <author@email.com>", in ["Tester1 <tester1@github.com>", "Tester2 <tester2@github.com>"].',
            sha: "18aebfa67dde85da0f5099ad70ef647685a05205",
            url: "https://github.com/hiimbex/testing-things/pull/1/commits/18aebfa67dde85da0f5099ad70ef647685a05205",
          },
        ]);
        ...
        expect(dcoObject).toEqual([
          {
            ...
            committer: "Bex Warner",
            message:
              'Expected "hiimbex <bex@disney.com>", but got "bex <bex@disney.com>".',
            sha: "18aebfa67dde85da0f5099ad70ef647685a05205",
          },
        ]);
      });
        ...
        expect(dcoObject).toEqual([
          {
            ...
            committer: "Bex Warner",
            message:
              'Expected "bex <hiimbex@disney.com>", but got "bex <bex@disney.com>".',
            sha: "18aebfa67dde85da0f5099ad70ef647685a05205",
          },
        ]);
      });
        ...
        expect(dcoObject).toEqual([
          {
            ...
            committer: "Bex Warner",
            message:
              'Expected "bex <bex@disney.com>", but got "hiimbex <hiimbex@disney.com>".',
            sha: "18aebfa67dde85da0f5099ad70ef647685a05205",
          },
        ]);
      });
        ...
        expect(dcoObject).toEqual([
          {
            ...
            committer: "Bex Warner",
            message:
              'Expected "Brandon Keepers <bkeepers@github.com>", but got "  Brandon Keepers  <bkeepers@github.com>".',
            sha: "18aebfa67dde85da0f5099ad70ef647685a05205",
          },
        ]);
      });
        ...
        expect(dcoObject).toEqual([
          {
            ...
            committer: "Bex Warner",
            message:
              'Expected "hiimbex <hiimbex@disney.com>", but got "hiimbex@disney.com <hiimbex>".',
            sha: "18aebfa67dde85da0f5099ad70ef647685a05205",
          },
        ]);
      });
        ...
        expect(dcoObject).toEqual([
          {
            ...
            committer: "Bex Warner",
            message:
              'Expected "hiimbex <hiimbex@disney.com>", but got "hiimbex <hiimbex(at)disney.com>".',
            sha: "18aebfa67dde85da0f5099ad70ef647685a05205",
          },
        ]);
      });
        ...
        expect(dcoObject).toEqual([
          {
            ...
            committer: "Bex Warner",
            message:
              'Expected "hiimbex <hiimbex@disney.com>", but got "hiimbex <hiimbex+alias@disney.com>".',
            sha: "18aebfa67dde85da0f5099ad70ef647685a05205",
          },
        ]);
      });
  ...
  describe("Two commits", () => {
    describe("Success patterns", () => {
      test("First commit is correctly signed-off; second commit is correctly signed-off", async () => {
        ...
        const dcoObject = await getDCOStatus(
          [
            { commit: commitA, author: { login: "hiimbex" }, parents: [] },
            {
              commit: commitB,
              author: { login: "hiimbex" },
              parents: [],
              sha: shaB,
            },
          ],
  ...
  describe("Disabled (default)", () => {
    describe("Failure patterns", () => {
      test("First commit does not contain a sign-off; second commit contains sign-off and correct individual remediation", async () => {
        ...
        const commitB = {
          message:
            "I, bex <bex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: bex <bex@disney.com>",
          author: {
            name: "bex",
            email: "bex@disney.com",
          },
        ...
        describe("Success patterns", () => {
          test("Single commit is correctly signed-off", async () => {
            ...
            const dcoObject = await getDCOStatus(
              ...
              alwaysRequireSignoff,
              prInfo,
              { individual: true, thirdParty: false }
            );
    ...
    describe("Verify individual remediations", () => {
      ...
      describe("Success patterns", () => {
        ...
        test("First commit contains a sign-off; second commit has individual remediation for a non-existent sha and sign-off", async () => {
          ...
          const commitB = {
            message:
              "I, bex <bex@disney.com>, hereby add my Signed-off-by to this commit: 2222222222222222222222222222222222222222\n\nSigned-off-by: bex <bex@disney.com>",
            author: {
              name: "bex",
              email: "bex@disney.com",
            },
      ...
      describe("Failure patterns", () => {
        ...
        test("First commit has no sign-off; second commit has remediation and sign-off from a different author name", async () => {
          ...
          const commitB = {
            message:
              "I, hiimbex <bex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: hiimbex <bex@disney.com>",
            author: {
              name: "hiimbex",
              email: "bex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has remediation and sign-off from a different author email", async () => {
          ...
          const commitB = {
            message:
              "I, bex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: bex <hiimbex@disney.com>",
            author: {
              name: "bex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has remediation and sign-off from a different author name and email", async () => {
          ...
          const commitB = {
            message:
              "I, hiimbex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
...
describe("THIRD PARTY REMEDIATION COMMITS", () => {
  ...
  describe("Disabled (default)", () => {
    describe("Failure patterns", () => {
      test("First commit does not contain a sign-off; second commit contains sign-off and correct third-party remediation", async () => {
        ...
        const commitB = {
          message:
            "On behalf of bex <bex@disney.com>, I, hiimbex <hiimbex@disney.com> hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
          author: {
            name: "hiimbex",
            email: "hiimbex@disney.com",
          },
  ...
  describe("Enabled via config option", () => {
        ...
        describe("Success patterns", () => {
          test("Single commit is correctly signed-off", async () => {
            ...
            const dcoObject = await getDCOStatus(
              ...
              alwaysRequireSignoff,
              prInfo,
              { individual: true, thirdParty: true }
            );
    ...
    describe("Verify third-party remediations", () => {
      describe("Success patterns", () => {
        test("First commit has no sign-off; second commit has correct 3rd party remediation from same author, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const commitB = {
            message:
              "On behalf of bex <bex@disney.com>, I, bex <bex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: bex <bex@disney.com>",
            author: {
              name: "bex",
              email: "bex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has correct 3rd party remediation from different author, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
        ...
        test("First commit has no sign-off; second commit has correct 3rd party remediation from committer, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const commitB = {
            message:
              "On behalf of bex <bex@disney.com>, I, Bex Warner <bexmwarner@gmail.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: Bex Warner <bexmwarner@gmail.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has correct 3rd party remediation from verified org member, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
        ...
        test("First commit has sign-off; second commit has redundant individual remediation, has sign-off; third commit has redundant third-party remediation, has sign-off", async () => {
          ...
          const commitC = {
            message:
              "On behalf of bex <bex@disney.com>, I, hiimbex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: d5f3e2be498459554b6465224b7b6f7c0682295e\n\nSigned-off-by: Bex Warner <bexmwarner@gmail.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has third-party remediation, no sign-off; third commit has individual remediation of second commit, has sign-off", async () => {
          ...
          const commitC = {
            message:
              "I, hiimbex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: d5f3e2be498459554b6465224b7b6f7c0682295e\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has third-party remediation, no sign-off; third commit has third-party remediation of second commit, has sign-off", async () => {
          ...
          const commitC = {
            message:
              "On behalf of hiimbex <hiimbex@disney.com>, I, Bex Warner <bexmwarner@gmail.com>, hereby add my Signed-off-by to this commit: d5f3e2be498459554b6465224b7b6f7c0682295e\n\nSigned-off-by: Bex Warner <bexmwarner@gmail.com>",
            author: {
              name: "Bex Warner",
              email: "bexmwarner@gmail.com",
            },
        ...
        test("First commit has no sign-off; second commit has correct 3rd party remediation text for first commit, no sign-off; third commit from committer has correct 3rd party remediation text for second commit, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
      ...
      describe("Failure patterns", () => {
        test("First commit has no sign-off; second commit has correct 3rd party remediation; individual remediations disabled", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const dcoObject = await getDCOStatus(
            ...
            alwaysRequireSignoff,
            prInfo,
            { individual: false, thirdParty: true }
          );
        ...
        test("First commit has no sign-off; second commit has 3rd party remediation for wrong email, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const commitB = {
            message:
              "On behalf of bex <hiimbex@disney.com>, I, hiimbex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has 3rd party remediation for wrong name, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const commitB = {
            message:
              "On behalf of Bex Warner <bex@disney.com>, I, hiimbex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has 3rd party remediation for wrong sha, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const commitB = {
            message:
              "On behalf of bex <bex@disney.com>, I, hiimbex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: 2222222222222222222222222222222222222222\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has mangled 3rd party remediation text, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const commitB = {
            message:
              "For bex <bex@disney.com>, I, hiimbex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has correct 3rd party remediation text but wrong remediator email, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const commitB = {
            message:
              "On behalf of bex <bex@disney.com>, I, hiimbex <bex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has correct 3rd party remediation text but wrong remediator name, has sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
          ...
          const commitB = {
            message:
              "On behalf of bex <bex@disney.com>, I, bex <hiimbex@disney.com>, hereby add my Signed-off-by to this commit: 18aebfa67dde85da0f5099ad70ef647685a05205\n\nSigned-off-by: hiimbex <hiimbex@disney.com>",
            author: {
              name: "hiimbex",
              email: "hiimbex@disney.com",
            },
        ...
        test("First commit has no sign-off; second commit has correct 3rd party remediation text, no sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
        ...
        test("First commit has no sign-off; second commit has correct 3rd party remediation text for first commit, no sign-off; third commit from committer has correct 3rd party remediation text for second commit, no sign-off", async () => {
          const commitA = {
            message: "No signoff",
            author: {
              name: "bex",
